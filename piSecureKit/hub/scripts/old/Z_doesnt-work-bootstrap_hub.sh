...
#sudo chmod +x /opt/PyGation/piSecureKit/hub/scripts/Z_doesnt-work-bootstrap_hub.sh
#sudo /opt/PyGation/piSecureKit/hub/scripts/Z_doesnt-work-bootstrap_hub.sh
#sudo systemctl reload hub